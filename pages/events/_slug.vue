...
export default {
  head() {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: this.launched.description },
 ...
 data() {
    ...
    async fetch() {
  const launch = await fetch(`https://beyond-api.glitch.me/api/events/${this.$route.params.slug}`)
    .then((res) => res.json())
